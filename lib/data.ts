...
export const portfolioItems = [
  {
    ...
    description:
      "A complete e-commerce solution for a technology retailer with inventory management, customer accounts, and payment processing.",
  ...
  },
  {
    ...
    description:
      "A comprehensive health tracking application that allows users to monitor fitness goals, nutrition, and medical appointments with personalized insights.",
    image: "/images/portfolio/health-hub.jpg",
    category: "Mobile App",
    client: "HealthHub",
  ...
  },
  {
    ...
    description:
      "An intuitive financial analytics dashboard for investment professionals with real-time data visualization and predictive modeling.",
  ...
  {
    id: 4,
    title: "EcoLife Brand Website",
    description:
      "A stunning brand website for an eco-friendly product line featuring immersive animations and an integrated shopping experience.",
    image: "/images/portfolio/ecolife.jpg",
    category: "Website",
  ...
  },
  {
    ...
    description:
      "A travel companion app with itinerary planning, local recommendations, and social sharing features for global travelers.",
    image: "/images/portfolio/travel-buddy.jpg",
    category: "Mobile App",
  ...
  {
    id: 6,
    title: "CreativeStudio CMS",
    description:
      "A custom content management system for a creative agency to manage client projects, digital assets, and team collaboration.",
...
export const teamMembers = [
  {
    ...
    name: "Alex Johnson",
    role: "Founder & CEO",
    bio: "Alex has over 15 years of experience in software development and business leadership. He founded DevForge with a vision to create digital solutions that truly impact businesses.",
...
export const testimonials = [
  {
    ...
    content:
      "Working with DevForge transformed our online presence. Their team delivered a stunning e-commerce platform that exceeded our expectations and has significantly increased our conversion rates.",
  ...
  },
  {
    ...
    content:
      "The mobile app DevForge created for us has received outstanding feedback from our users. Their attention to detail and focus on user experience really sets them apart from other agencies.",
    image: "/images/testimonials/robert.jpg",
  },
  {
    id: 3,
    name: "Amanda Thompson",
    role: "Marketing Director, FinTrack",
    content:
      "DevForge didn't just build us a website, they created a powerful tool that has become central to our business operations. Their strategic approach and technical expertise are unmatched.",
    image: "/images/testimonials/amanda.jpg",
  },
  {
    id: 4,
    name: "Daniel Garcia",
    role: "CTO, EcoLife Products",
    content:
