...
import BookCall from "@/components/Cal";
...
import { WorldMapMain } from "@/components/WorldMapMain";
              ...
              >
                <div className="glass-card rounded-2xl p-6">
                  ...
                  <div className="bg-secondary/20 rounded-xl p-4 text-center">
                    <button
                      onClick={handleClick}
                      className="bg-gradient-to-r from-indigo-500 to-purple-700 hover:from-indigo-600 hover:to-purple-800 transition-all px-2.5 py-2 w-full rounded-md"
                    >
                      Book a Call
                    </button>
                  </div>
              ...
              <div className="space-y-8">
                <div className="glass-card rounded-2xl p-6">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    testing, and launch phases, with regular check-ins
                    throughout.
                  </p>
                </div>
                ...
                <div className="glass-card rounded-2xl p-6">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    simple website might take 4-6 weeks, while a complex web
                    application could take 3-6 months. We'll provide a detailed
                ...
                <div className="glass-card rounded-2xl p-6">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    keep your digital products running smoothly after launch.
                    These can include regular updates, security monitoring,
